										...
										<tbody>
											{ledgers.map((ledger, index) => (
												<tr key={ledger.id} className='cursor-pointer text-center text-gray-600 text-xs font-normal'>
													...
													<td className="py-2 px-4 border-b">{ledger.date}</td>
													<td className="py-2 px-4 border-b">{ledger.name}</td>
													<td className="py-2 px-4 border-b">{ledger.reference}</td>
													<td className="py-2 px-4 border-b">{ledger.group}</td>
